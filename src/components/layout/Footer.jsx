        ...
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <h2 className="text-2xl font-semibold">North Wave</h2>
              <p>
                North Wave is a full-service digital marketing agency that helps
                great companies grow their revenues online.
              </p>
              <p class="max-w-xs mt-4 text-2xl font-bold">
                sales@northwave.com
              </p>
          ...
          <p class="mt-8 text-xs text-gray-800">© 2023 North Wave</p>
        </div>
      </footer>
    </>
  );
