...
const About = () => {
  return (
    <Container>
      <div className="flex flex-col gap-6">
        ...
        <FadeIn>
          <div className="flex flex-col md:flex-row items-start gap-10">
            <p className="mx-w-2xl text-3xl mt-2  tracking-widest">
      ...
      <div className="flex flex-col mt-10 gap-6 bg-gray-300">
        <FadeIn>
        ...
        <FadeIn>
          <div className="flex flex-col md:flex-row items-start gap-10">
            ...
            <p className="mx-w-2xl text-3xl mt-4  tracking-widest">
              ...
              <Link href={"/contact"}>
                {" "}
                <button className="w-100 px-4   h-12 rounded-xl bg-blue-500 text-white uppercase font-medium hover:bg-green-950 cursor-pointer duration-300">
